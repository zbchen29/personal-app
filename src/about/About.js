            ...
            <div>
                ...
                <PanelContainer>
                    ...
                    <div className="p-3 theme-text-sm">
                        I am a student at MIT pursuing a degree in Computer Science and Engineering.  Among my friends, I go by the substantially simpler nickname Ben.  Beyond my courses, I am deeply interested in astronomy/space exploration, education, history, and energy sustainability.
                    </div>
                    <div className="p-3 theme-text-sm">
                    ...
                    <div className="d-flex flex-row flex-wrap justify-content-around p-3">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/zbchen/" className="theme-text-sm group-link p-2"><div className="info-link d-flex flex-column align-items-center">
                            <img className="info-icon" src={linkedin_icon} alt="linkedin icon"/>
                            <div className="text-link">LinkedIn</div>
                        </div></a>
                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/zbchen29" className="theme-text-sm group-link p-2"><div className="info-link d-flex flex-column align-items-center">
                            <img className="info-icon" src={github_mark} alt="github icon"/>
                            <div className="text-link">GitHub</div>
                        </div></a>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.behance.net/rigelb8ia7cd80" className="theme-text-sm group-link p-2"><div className="info-link d-flex flex-column align-items-center">
                            <img className="info-icon" src={behance_icon} alt="behance icon"/>
                            <div className="text-link">Behance</div>
                        </div></a>
                        <div className="info-link d-flex flex-column align-items-center theme-text-sm p-2">
