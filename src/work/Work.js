            ...
            <div>
                ...
                <PanelContainer>
                    ...
                    <Feature format="image-right" image={microsoft} link="https://www.microsoft.com/">
                        ...
                        <div className="feature-text">I worked on <a href="https://microsoft.github.io/art/" className="feature-text-b feature-text-link" target="_blank" rel="noopener noreferrer">Mosaic</a>, a project that leverages machine learning to find artwork connections across cultures and mediums in collaboration with <a href="https://www.metmuseum.org/" className="feature-text-b feature-text-link" target="_blank" rel="noopener noreferrer">The Met</a> and the <a href="https://www.rijksmuseum.nl/en" className="feature-text-b feature-text-link" target="_blank" rel="noopener noreferrer">Rijksmuseum</a>.  The app incorporates Azure Machine Learning, Azure Kubernetes Services, and UI Fabric for React.</div>
                    </Feature>
